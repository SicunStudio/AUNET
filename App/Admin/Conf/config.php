...
return array(
    ...
    'NOT_AUTH_ACTION'      =>'rbac_index,logout,addUserHandle,addNodeHandle,addRoleHandle,access,setAccess,lock,editpwd,editpwdHandle,delNode
                            runAddCate,sortCate,runAddAttr',
