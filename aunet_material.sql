...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-02-18 09:35:12
-- 服务器版本： 5.6.26
-- PHP Version: 5.6.12
...
DROP TABLE IF EXISTS `aunet_buildingclassroom`;

DROP TABLE IF EXISTS `aunet_buildingclassroom2`;

DROP TABLE IF EXISTS `aunet_colorprinting`;

DROP TABLE IF EXISTS `aunet_eastthird`;

DROP TABLE IF EXISTS `aunet_specialplace`;

DROP TABLE IF EXISTS `aunet_sportcourt`;

DROP TABLE IF EXISTS `aunet_studentcenter`;

DROP TABLE IF EXISTS `aunet_otherplace`;

DROP TABLE IF EXISTS `aunet_otherstuff`;

DROP TABLE IF EXISTS `aunet_roadshow`;

DROP TABLE IF EXISTS `aunet_stuff`;
...
DROP TABLE IF EXISTS `aunet_material_east4`;
...
DROP TABLE IF EXISTS `aunet_material_materialapply`;
...
DROP TABLE IF EXISTS `aunet_material_outdoor`;
...
DROP TABLE IF EXISTS `aunet_material_sacenter`;
...
DROP TABLE IF EXISTS `aunet_material_sports`;
